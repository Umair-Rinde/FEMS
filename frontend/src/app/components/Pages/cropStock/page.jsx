...
const CropStockForm = () => {
    ...
    return (
        <section className="w-full h-screen bg-[#ccffcc] p-4  m-auto flex flex-col justify-center items-center">
        <form className="flex flex-col gap-5 w-full  justify-center opacity-100 p-4 bg-[#e5ffe5]">
        <span className='flex gap-2 '>
          ...
          <h1 className="text-2xl font-bold ">Crop Stock</h1>
            ...
            <div className="flex items-center justify-center gap-3 my-5 font-semibold">
                ...
                <button className="px-4 py-1 bg-gray-300 hover:text-white hover:bg-[#42cd42] rounded-sm"
