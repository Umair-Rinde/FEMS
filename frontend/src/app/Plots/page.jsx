...
import PlotsForm from "../components/Pages/Plots";
      ...
      <div className="w-1/6"><SideNavbar /></div>
        <page className=" w-2/3 flex flex-col m-auto">
          <section className="w-full h-full px-2 py-10">
            <div>
                <h2 className="text-3xl font-bold mx-1 w-full pb-2 text-green-500">Plots</h2>
            </div>
            <div className="w-full h-full flex-col gap-3 p-3 rounded-2xl lg:rounded-4xl border border-green-500 bg-[#FFFFFF] opacity-80"  
              style={{
