...
exports.MetaDataModule = MetaDataModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([meta_model_1.MetaData])],
        controllers: [meta_controller_1.MetaDataController],
        providers: [meta_service_1.MetaDataService]
    })
], MetaDataModule);
