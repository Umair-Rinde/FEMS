  ...
  return (
    <section className="w-screen md:flex grid grid-col-1 bg-black text-white justify-between pt-4">
      <div className="flex flex-col  p-4 font-semibold">
        <div className="flex">
          <Image src={fems_logo} alt="logo" className="w-10 h-10 rounded-xl" />
      ...
      <div className="flex flex-col gap-2 md:p-2 p-4 text-[13px]">
        <div className="md:flex ">
          <div className="px-8">
            <li className="text-[#00FF00] list-none py-2 font-semibold">
              Products
            </li>
          ...
          <div className="px-8">
            ...
            <li className="list-none py-2 hover:underline ">
      ...
      <div className="flex flex-col md:p-4 p-10 gap-2 font-semibold text-[13px]">
        ...
        <div className="flex w-[150px] bg-[#00FF00] p-1 rounded-sm gap-5">
          <span>
            <BsFacebook className="w-5 h-5  text-black" />
          </span>
          <span>
        ...
        <div className="flex">
          <input
            ...
            className="text-gray-800 rounded-sm py-1 px-4"
          />
          <button className="bg-[#00FF00] rounded-sm mx-2 py-1 px-4">
            Enter
          </button>
        </div>
      </div>
