...
class BaseModel extends sequelize_typescript_1.Model {
    static _validateIncludedElements(options, tableNames) {
        ...
        for (const include of options.include) {
            ...
            if (options.topModel === options.model &&
            ...
            if (include.association.isSingleAssociation ||
    ...
    static _validateIncludedElement(include, tableNames, options) {
        ...
        if (include.attributes && !options.raw) {
            ...
            include = sequelize_1.Utils.mapFinderOptions(include, include.model);
        ...
        if (include._pseudo) {
            ...
            return sequelize_1.Utils.mapFinderOptions(include, include.model);
        }
        ...
        if (include.association.through &&
            ...
            if (through.scope) {
                include.through.where = include.through.where
                    ? { [sequelize_1.Op.and]: [include.through.where, through.scope] }
                    : through.scope;
            }
        ...
        if (include.association.scope) {
            include.where = include.where
                ? { [sequelize_1.Op.and]: [include.where, include.association.scope] }
        ...
        if (include.separate === true) {
            if (!(include.association instanceof sequelize_typescript_1.HasMany)) {
